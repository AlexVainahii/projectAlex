 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(i=Or,s=n,o=r,yn(V(i),rn.credential(s,o))).then((e=>{Nr(e.user)})).catch((e=>{e.code,e.message}))})),t.signUpBtn.addEventListener("click",(function(e){e.preventDefault();const n=t.inputEmail.value,r=t.inputPass.value;In(Or,n,r).then((e=>{const t=e.user;return Nr(t.email),t})).catch((e=>{const t=e.code,n=e.message;console.log(t,n)}))})),t.signOutBtn.addEventListener("click",(function(){var e;(e=Or,V(e).signOut()).then((()=>{t.signBtn.innerText="Sign In",t.signBtn.removeAttribute("disabled"),t.signOutBtn.classList.toggle("is-hidden")})).catch((e=>{}))})),t.googleBtn.addEventListener("click",(function(e){e.preventDefault,Jn(Or,Rr).then((e=>{Nr(e.user.displayName)})).catch((e=>{e.code,e.message,e.customData.email,cn.credentialFromError(e)}))})),t.faseBtn.addEventListener("click",(function(e){e.preventDefault,Jn(Or,Ar).then((e=>{Nr(e.user.displayName)})).catch((e=>{e.code,e.message,e.customData.email,an.credentialFromError(e)}))}));
//# sourceMappingURL=index.1ff6bc59.js.map
