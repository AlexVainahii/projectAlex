 ...
 * limitations under the License.
 */
const Er=O("authIdTokenMaxAge")||300;let kr=null;function Sr(e=Oe()){const t=Te(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=Te(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(P(n.getOptions(),null!=t?t:{}))return e;We(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:wr,persistence:[xn,Tn,kn]}),r=O("authTokenSyncURL");if(r){const e=(i=r,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>Er)return;const r=null==t?void 0:t.token;kr!==r&&(kr=r,await fetch(i,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))});!function(e,t,n){V(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,r){V(e).onIdTokenChanged(t,n,r)}(n,(t=>e(t)))}var i;const s=S("auth");return s&&qt(n,`http://${s}`),n}var Or;Or="Browser",we(new H("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),{apiKey:i,authDomain:s}=n.options;return((e,n)=>{Je(i&&!i.includes(":"),"invalid-api-key",{appName:e.name}),Je(!(null==s?void 0:s.includes(":")),"argument-error",{appName:e.name});const r={apiKey:i,authDomain:s,clientPlatform:Or,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Vt(Or)},o=new zt(e,n,r);return function(e,t){const n=(null==t?void 0:t.persistence)||[],r=(Array.isArray(n)?n:[n]).map(Ze);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(r,null==t?void 0:t.popupRedirectResolver)}(o,t),o})(n,r)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),we(new H("auth-internal",(e=>{const t=Wt(e.getProvider("auth").getImmediate());return new Tr(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Re("@firebase/auth","0.20.11",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Or)),Re("@firebase/auth","0.20.11","esm2017");Se({apiKey:"AIzaSyDRjTFbmRann_cr3ckzqO-WJzrN46pmMNY",authDomain:"ultimate-choir-311114.firebaseapp.com",projectId:"ultimate-choir-311114",storageBucket:"ultimate-choir-311114.appspot.com",messagingSenderId:"747352375066",appId:"1:747352375066:web:bfd52aa1c7f0703dcff6a3",measurementId:"G-XPVPECFXHK"});const Rr=Sr(),Ar=new cn,Cr=new an;function Nr(){t.bckDrop.classList.add("is-hidden")}function Dr(e){t.signBtn.innerText=e,t.inputEmail.value="",t.inputPass.value="",t.signBtn.setAttribute("disabled","disabled"),t.signOutBtn.classList.toggle("is-hidden"),Nr()}t.signBtn.addEventListener("click",(function(){t.bckDrop.classList.remove("is-hidden")})),t.closeBtn.addEventListener("click",Nr),t.signInBtn.addEventListener("click",(function(e){e.preventDefault();const n=t.inputEmail.value,r=t.inputPass.value;var i,s,o;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(i=Rr,s=n,o=r,yn(V(i),rn.credential(s,o))).then((e=>{Dr(e.user)})).catch((e=>{e.code,e.message}))})),t.signUpBtn.addEventListener("click",(function(e){e.preventDefault();const n=t.inputEmail.value,r=t.inputPass.value;In(Rr,n,r).then((e=>{const t=e.user;return Dr(t.email),t})).catch((e=>{const t=e.code,n=e.message;console.log(t,n)}))})),t.signOutBtn.addEventListener("click",(function(){var e;(e=Rr,V(e).signOut()).then((()=>{t.signBtn.innerText="Sign In",t.signBtn.removeAttribute("disabled"),t.signOutBtn.classList.toggle("is-hidden")})).catch((e=>{}))})),t.googleBtn.addEventListener("click",(function(){Jn(Sr(),Ar).then((e=>{Dr(e.user.displayName)})).catch((e=>{e.code,e.message,e.customData.email,cn.credentialFromError(e)}))})),t.faseBtn.addEventListener("click",(function(){Jn(Rr,Cr).then((e=>{Dr(e.user.displayName)})).catch((e=>{e.code,e.message,e.customData.email,an.credentialFromError(e)}))}));
//# sourceMappingURL=index.fa867191.js.map
